        ...
        for player_turn_result in player_turn_results:
            ...
            if equip:
                ...
                for equip_result in equip_results:
                    ...
                    dequiped = equip_results.get('dequipped')
                    
                    if equipped:
                        message_log.add_message(Message('You\'ve equipped the {0}'.format(equipped.name)))
                        
                    if dequipped:
                        message_log.add_message(Message('You\'ve dequipped the {0}'.format(dequipped.name)))
